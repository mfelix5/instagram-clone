        ...
        } >
            {
                this.state.loaded === false ? (
                    <View>
                        ...
                        <View style={{ flex: 1 }}>
                            <View style={{ flexDirection: 'row', height: 70, paddingTop: 30, backgroundColor: "white", borderColor: "lightgray", borderBottomWidth: 0.5, justifyContent: "space-between", alignItems: "center" }}>
                                <TouchableOpacity
                                    style={{width: 100}}
